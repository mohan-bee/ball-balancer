...
function OverlayApp() {
  const [usageOpen, setUsageOpen] = import_react4.useState(false);
  const [debugOpen, setDebugOpen] = import_react4.useState(false);
  const [panelState, setPanelState] = import_react4.useState({
    status: "Connecting",
    meta: "Waiting",
    ...
    const startPolling = () => {
      ...
      const poll = async () => {
        try {
          ...
          if (state.type !== "state" || typeof state.x !== "number" || typeof state.z !== "number" || typeof state.readout !== "string") {
            return;
          }
          applyState({
            x: state.x,
              ...
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("ul", {
                ...
                children: [
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("li", {
                    children: "Move the device to tilt the tray."
                  }, undefined, false, undefined, this),
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("li", {
                    children: "Use the debug icon on the right for live packets."
                  }, undefined, false, undefined, this),
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("li", {
                    children: "The ball follows gyro x and z only."
                  }, undefined, false, undefined, this)
                ]
              }, undefined, true, undefined, this)
            ]
