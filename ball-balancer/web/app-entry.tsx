          ...
          <div className="setup-section">
            <div className="setup-step">
              ...
              <div className="pairing-qr">
                <a href="https://expo.dev/artifacts/eas/sf2KVfkt4MLq2tE2H3T5v9.apk" target="_blank" rel="noreferrer">
                  <QRCodeSVG
              ...
              <a className="pairing-copy" href="https://expo.dev/artifacts/eas/sf2KVfkt4MLq2tE2H3T5v9.apk" target="_blank" rel="noreferrer">
